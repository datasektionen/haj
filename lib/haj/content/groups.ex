  ...
  @groups [
         ...
         belåtna under föreställningarna då vi lagar mat."
            ...
            %{
              ...
              description:
                "Regi är ansvariga för att leda squådisgruppen och all regi under spexet."
            },
            %{
              name: "Fotofilm",
              members: [
      ...
      Sminq planerar också karaktärers smink baserat på karaktärernas personligheter!"
          ...
          |> Enum.map(fn group ->
            Map.update!(group, :image, fn image -> Haj.Image.new(image) |> Imgproxy.resize(1800, 1200) |> to_string()end)
          end)
