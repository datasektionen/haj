defmodule Haj.Content.About do
  ...
  def get_index_data() do
    [
      %{
        title: "Om METAspexet",
        description:
          "METAspexet är ett spex gjord i samarbete mellan Datasektionen och Medieteknik på KTH. Vi sätter varje år upp en interaktiv studentteater med musikinslag. Vi engagerar omkring 120 spexare i ett stort antal grupper som tillsammans hjälps åt för att skapa en fantastisk föreställning varje år!",
      ...
      %{
        title: "Spexhistoria",
        description: "METAspexet grundades 2011 och har vuxit storartat under den tiden.",
  ...
  def get_previous_spex() do
    spex = [
      ...
      %{
        title: "Mordet på Occidentexpressen",
        or_title: "En mördare på spåren",
        year: 2013,
        synopsis: ""
      },
      %{title: "Se mig Dr. Clock", or_title: nil, year: 2014, synopsis: ""},
      %{
        title: "MetaMetaSpexet",
        or_title: "Lär en metalog att meta och de är meta för livet",
        year: 2015,
        synopsis:
          "Byggnadsingenjörssektionen ska sätta upp spexet “Jurrassic Campus” eller “När studenten kommer till Krita”, men direktören har försvunnit med all budget. Chefsgruppen måste nu snabbt försöka att lösa problemet så att det blir ett spex alls. Personer hamnar i fel grupper och två av skådisarna försöker att sätta käppar i hjulen för det nya stjärnskottet Anna. Ska de lyckas få ihop ett spex?"
      },
      %{
        title: "Kiseldalen",
        or_title: "Det dalar för familjen",
        year: 2016,
        synopsis:
          "Flera tusen år in i framtiden har allting blivit uppfunnet och alla patent ägs av en organisation som kallas “Familjen”. Den aspirerande uppfinnaren Siv Jobsson lyckas en dag uppfinna något nytt. Med hjälp av sina vänner och sin advokat måste hon försöka ta patent på sin uppfinning och krossa familjens monopol på patent. Men hon har mycket emot sig. Förutom familjens advokat finns även demonen Lucifer i bakgrunden och försöker att ställa till oreda så att han själv kan styra världen."
      },
      %{
        title: "Scenskräck",
        or_title: "Skogen är ett kult ställe",
        year: 2017,
        synopsis:
          "Häng med ut till en enslig stuga i skogen, där syskonen Douglas och Alex ska spendera en lugn och stillsam helg med sina vänner. Men allt är inte riktigt som det verkar… Mystiska saker försiggår i skogen, eller är det bara någon som försöker spela dem ett spratt?"
      },
      %{
        title: "Boston Tea Party",
        or_title: "Ett skepp kommer vaskat",
        year: 2018,
        synopsis:
          "En kall decemberdag 1773 möts Lena Svensson, teälskare extraordinaire och Bostonit… well, ganska ordinaire, av en hemsk syn när hon kommer till jobbet. Inte ett blad te finns att uppbringa i hela staden, och hur kan Lena klara av sin irriterande chef utan en lugnande kopp te (eller elva)?
      ...
      %{
        title: "Elementärt",
        or_title: "Från skrivbord till herrgårdsmord",
        year: 2019,
        synopsis:
