defmodule HajWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-4xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-6 shadow-lg ring-1 transition md:p-14"
            >
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name} class={@class}>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-zinc-500 focus:outline-none focus:ring-zinc-500 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
      ...
      >
        <div class="flex h-6 items-center">
          <input
            ...
            class="text-burgandy-600 h-4 w-4 border-gray-300 focus:ring-burgandy-600"
          />
        </div>
        <div class="text-sm/6 ml-3">
