defmodule HajWeb.PublicRouter do
  ...
  pipeline :browser do
    ...
    plug :put_layout, {HajWeb.LayoutView, :public}
  ...
  scope "/", HajWeb do
    ...
    get "/groups", PublicController, :groups
    get "/groups/:name", PublicController, :group
    get "/spexet", PublicController, :spex
    get "/previous", PublicController, :previous
