defmodule MetaspexetWeb.SessionController do
  use MetaspexetWeb, :controller
  alias Metaspexet.Accounts
  alias MetaspexetWeb.UserAuth

  @host Application.get_env(:metaspexet, :login_host)
  @api_key Application.get_env(:metaspexet, :login_api_key)
