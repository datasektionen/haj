defmodule MetaspexetWeb.PageView do
  ...
  def card(assigns) do
    ~H"""
    <div class="rounded-sm overflow-hidden md:relative from-black after:bg-gradient-to-t after:overflow-hidden after:invisible after:absolute after:top-0 after:left-0 after:w-full after:h-full after:z-0 md:after:visible xl:after:invisible">
      ...
      <div class="md:absolute xl:relative left-0 bottom-0 z-10 md:p-6  md:max-w-xl xl:max-w-none xl:p-0">
        <h1 class="font-title text-3xl pt-4 pb-2 md:text-4xl"><%= assigns.card.title %></h1>
        <p><%= assigns.card.description %></p>
        <a class="flex items-center space-x-2 pt-4 md:pt-6 xl:pt-4">
