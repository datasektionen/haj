...
@create_attrs %{description: "some description", title: "some title", display_votes: true, allow_user_options: true}
@update_attrs %{description: "some updated description", title: "some updated title", display_votes: false, allow_user_options: false}
