...
{:ok, _index_live, html} = live(conn, ~p"/live/settings/forms")
...
{:ok, index_live, _html} = live(conn, ~p"/live/settings/forms")

assert index_live |> element("a", "New Form") |> render_click() =~
"New Form"

assert_patch(index_live, ~p"/live/settings/forms/new")
...
assert_patch(index_live, ~p"/live/settings/forms")
...
assert_patch(index_live, ~p"/live/settings/forms/#{form}/edit")
...
{:ok, _show_live, html} = live(conn, ~p"/live/settings/forms/#{form}")
...
{:ok, show_live, _html} = live(conn, ~p"/live/settings/forms/#{form}")

assert show_live |> element("a", "Edit") |> render_click() =~
"Edit Form"

assert_patch(show_live, ~p"/live/settings/forms/#{form}/show/edit")
...
assert_patch(show_live, ~p"/live/settings/forms/#{form}")
